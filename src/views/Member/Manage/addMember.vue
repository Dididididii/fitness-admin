<template>
  <div class="add-card">
    <header class="add-header">
      <el-page-header content="添加会员" @back="$router.back()" />
    </header>
    <main class="add-main">
        ...
        <div class="form">
          <el-form ref="addForm" label-width="100px" :model="addForm" :rules="rules">
            ...
            <el-form-item label="身份证号码" prop="identityCard">
              <el-input v-model="addForm.identityCard" />
            </el-form-item>
            <el-form-item label="健身卡" prop="cards">
              <el-select v-model="addForm.cards">
                <el-option v-for="item in options" :key="item.value" :value="item.value" :label="item.label" />
              </el-select>
            </el-form-item>
            <el-form-item label="会员课" prop="course">
              <el-input v-model="addForm.course" type="number" min="0" max="50" />
            </el-form-item>
            <el-form-item label="专属私教" prop="coach">
              <el-input v-model="addForm.coach" />
            </el-form-item>
            <el-form-item label="支付金额" prop="payNum">
              <el-input v-model="addForm.payNum" />
            </el-form-item>
...
<script>
import { addMemberAPI } from '@/api/member'
